...
async def query_ollama(prompt: str, image_data: Optional[str] = None) -> Dict[str, Any]:
    data = {
        ...
        "prompt": (
            ...
            "Express the velocity of the car in meters per second (m/s)."
            ...
            "Provide various responses such as 'move forward slowly,' 'turn left slowly,' 'turn right slowly,' or 'U-turn cautiously' depending on the situation where an obstacle appears ahead."
            "If an obstacle appears in front of you, drive at 0.5 times your current speed. In addition, depending on the situation, various options such as left turn, right turn, battery, and U-turn are selected for autonomous driving."
        ...
        for _ in range(iterations):
            if jetbot_websocket:
                command_message = json.dumps({
                    "command": command,
                    "parameters": {"speed": 0.2, "duration": 0.4}  # Default parameters
                })
